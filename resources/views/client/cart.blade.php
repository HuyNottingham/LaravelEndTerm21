...
@section('content')
    ...
    <form action="{{route('cart')}}" method="post" novalidate style="display:block"
      ...
      <div class="cart_items js_cat_items">
        <div class="cart_item js_cart_item cart_item_35335215710365">
          ...
          <div class="row al_center">
            <div class="col-12 col-md-12 col-lg-5">
              <div class="page_cart_info flex al_center"><a href="{{route('productdetails')}}"><img
                    ...
                    data-widths="[120, 240]" data-sizes="auto" alt=""></a>
                <div class="mini_cart_body ml__15">
                  <h5 class="mini_cart_title mg__0 mb__5"><a href="{{route('productdetails')}}">Blue
                      Cotton Leggings</a></h5>
                  <div class="mini_cart_meta">
                    <p class="cart_meta_variant">Color: <strong>Black</strong></p>
                    <p class="cart_meta_variant">Size: <strong>XS</strong></p>
                  </div>
                  <div class="mini_cart_tool mt__10"><a href="{{route('productdetails')}}"
                      rel="nofollow" data-no-instant class="cart_ac_edit js__qs ttip_nt tooltip_top_right"
                      data-id="35335215710365"><span class="tt_txt">Edit this item</span><svg viewBox="0 0 24 24">
                        <use xlink:href="#scl_edit" />
                      </svg></a><a href="{{route('cartchange')}}?quantity=0&amp;id=35335215710365:7a791ad935aeb6b3aed706fe9a02537d"
                      rel="nofollow" data-no-instant class="cart_ac_remove js_cart_rem ttip_nt tooltip_top_right"
                      data-id="35335215710365:7a791ad935aeb6b3aed706fe9a02537d"><span class="tt_txt">Remove this item</span><svg
                        viewBox="0 0 24 24">
                        <use xlink:href="#scl_remove" />
                      </svg></a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-md-4 col-lg-2 tc mini_cart_actions">
              <div class="quantity pr mr__10 qty__true">
                <input type="number" id="miniupdates_35335215710365:7a791ad935aeb6b3aed706fe9a02537d"
                  ...
                  class="input-text qty text tc qty_cart_js" step="1" min="0" max="9999" name="updates[]" value="1" size="4"
                  pattern="[0-9]*" inputmode="numeric">
                <div class="qty tc fs__14">
                  <button type="button" class="plus db cb pa pd__0 pr__15 tr r__0"><i
                      class="facl facl-plus"></i></button><button type="button"
                    class="minus db cb pa pd__0 pl__15 tl l__0 qty_1"><svg class='dn' viewBox="0 0 24 24">
                      <use xlink:href="#scl_remove" />
                    </svg><i class="facl facl-minus"></i></button>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-4 col-lg-2 tc__ tr_lg">
              <span class="cart-item-price fwm cd js_tt_price_it"><span class=money>$30.00</span></span>
            </div>
          </div>
        </div>
        ...
        <div class="cart_item js_cart_item cart_item_35335279181981">
          ...
          <div class="row al_center">
            <div class="col-12 col-md-12 col-lg-5">
                <div class="page_cart_info flex al_center"><a href="{{route('productdetails')}}"><img class="w__100 lz_op_ef lazyautosizes lazyloaded" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20750%201101%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-widths="[120, 240]" data-sizes="auto" alt="" data-srcset="//cdn.shopify.com/s/files/1/0437/1913/1293/products/g-1_120x.jpg?v=1600324872 120w, //cdn.shopify.com/s/files/1/0437/1913/1293/products/g-1_240x.jpg?v=1600324872 240w" sizes="120px" srcset="//cdn.shopify.com/s/files/1/0437/1913/1293/products/g-1_120x.jpg?v=1600324872 120w, //cdn.shopify.com/s/files/1/0437/1913/1293/products/g-1_240x.jpg?v=1600324872 240w"></a><div class="mini_cart_body ml__15">
                      <h5 class="mini_cart_title mg__0 mb__5"><a href="{{route('productdetails')}}">Square Embroidery T-Shirt</a></h5>
                    <div class="mini_cart_meta"></div>
                    <div class="mini_cart_tool mt__10"><a href="{{route('cartchange')}}?quantity=0&amp;id=35335279181981:597052d67c4f6c7ce89987750b49937f" rel="nofollow" data-no-instant="" class="cart_ac_remove js_cart_rem ttip_nt tooltip_top_right" data-id="35335279181981:597052d67c4f6c7ce89987750b49937f"><span class="tt_txt">Remove this item</span><svg viewBox="0 0 24 24"><use xlink:href="#scl_remove"></use></svg></a>
                      </div>
                  </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4 col-lg-2 tc mini_cart_actions">
                <div class="quantity pr mr__10 qty__true">
                    <input type="number" id="miniupdates_35335279181981:597052d67c4f6c7ce89987750b49937f" data-id="35335279181981:597052d67c4f6c7ce89987750b49937f" data-price="3000" class="input-text qty text tc qty_cart_js" step="1" min="0" max="9999" name="updates[]" value="1" size="4" pattern="[0-9]*" inputmode="numeric">
                    <div class="qty tc fs__14">
                      <button type="button" class="plus db cb pa pd__0 pr__15 tr r__0"><i class="facl facl-plus"></i></button><button type="button" class="minus db cb pa pd__0 pl__15 tl l__0 qty_1"><svg class="dn" viewBox="0 0 24 24"><use xlink:href="#scl_remove"></use></svg><i class="facl facl-minus"></i></button>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-2 tc__ tr_lg">
        ...
        <div class="row">
          <div class="col-12 col-md-6 cart_actions tl_md tc order-md-2 order-2 mb__50">
            <div class="gift_wrap row al_center tc tl_md mb__25 js_gift_wrap">
              <div class="gift_wrap_info col-lg-7 col-12">
                ...
                <span class="gift-wrap__text mt__10 mb__10 dib"><span class="cd">Do you want a gift wrap?</span>
                        Only <span class=money>$10.00</span></span>
              </div>
              <div class="gift_wrap_action col-lg col-12 tr_lg tl_md">
                <a href="{{route('shop-gift_wrapping')}}" data-id="35335096041629" class="button truncate js_addtc">Add
                        A Gift Wrap</a>
              </div>
            </div><label for="CartSpecialInstructions" class="cart-note__label dib cd mb__10"><span
                      class="txt_add_note ">Add Order Note</span><span class="txt_edit_note dn">Edit Order
                      Note</span></label>
            <textarea name="note" id="CartSpecialInstructions" class="cart-note__input"
                    placeholder="How can we help you?"></textarea><label for="couponcode"
          ...
          <div class="col-12 tr_md tc order-md-4 order-4 col-md-6">
            <div class="fs__14 cd cart_thres_js">
              <div class="cart_thres_2">Almost there, add <span class="cr fwm mn_thres_js"><span
                          class=money>$100.00</span></span> more to get <span class="cr fwm">FREE SHIPPING!</span></div>
              <div class="cart_thres_3 dn"><span class="cr fwsb">Congratulations!</span> You&#39;ve got free
                      shipping!</div>
              <div class="cart_bar_w bgt4_svg19 pr"><span class="pr db h__100 less_10" style="width: 0.0%"></span>
              </div>
            </div>
            ...
            <p class="db txt_tax_ship mb__5">Taxes, shipping and discounts codes calculated at checkout
            </p>
            <p class="pr dib mb__5"><input type="checkbox" id="cart_agree" class="js_agree_ck mr__5"
            ...
            <div class="clearfix"></div><button type="submit" name="update"
            ...
            <button type="submit" data-confirm="ck_lumise" name="checkout"
                    class="btn_checkout button button_primary tu mt__10 mb__10 js_add_ld w__100">Check Out</button>
            <div class="clearfix"></div>
          </div>
        </div>
      </div>
  ...
  <div id="shopify-section-recently_viewed" class="shopify-section tp_se_cdt mb__60">
    <div class="related product-extra mt__60" id="recently_wrap" data-section-type="product-recently"
            data-get="{{route('products-search')}}" data-unpr='show' data-id="id:19041994" data-limit="6" data-expands="-1">

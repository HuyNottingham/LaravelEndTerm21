...
<head>
  ...
  <meta data-body-font-family="-apple-system, BlinkMacSystemFont, &#39;Segoe UI&#39;, Roboto, Helvetica, Arial, sans-serif, &#39;Apple Color Emoji&#39;, &#39;Segoe UI Emoji&#39;, &#39;Segoe UI Symbol&#39;"
  ...
  <meta name="shopify-checkout-authorization-token" content="05e886f2f53097add97dcdf0c71813b0">
  ...
  <meta property="og:title" content="Purchase Black In Faux JX Suede">
  <meta property="og:image"
    content="https:https://cdn.shopify.com/s/files/1/0437/1913/1293/products/org_0000s_0017s_0000_1_1024x1024.jpg?v=1599129436">

  <!--[if lt IE 9]>
  <link rel="stylesheet" media="all" href="https://cdn.shopify.com/app/services/43719131293/assets/111512715421/checkout_stylesheet/v2-ltr-edge-efa0a63b8eb42aba8cfba1e6c680e7fc-5123/oldie">
  <![endif]-->

  <!--[if gte IE 9]><!-->
  <link rel="stylesheet" media="all" href="https://cdn.shopify.com/app/services/43719131293/assets/111512715421/checkout_stylesheet/v2-ltr-edge-efa0a63b8eb42aba8cfba1e6c680e7fc-5123">
  <!--<![endif]-->
  ...
  <script src="https://cdn.shopify.com/app/services/43719131293/javascripts/checkout_countries/111512715421/en/countries-f1b55c395acc5e4c56c204e3cb8ebf4d911f4cd9-f1b55c395acc5e4c56c204e3cb8ebf4d911f4cd9-1621582197-d295b8ba1ab1e296ee2c6d377b1e79b7a1dddd34.js?version=edge" crossorigin="anonymous"></script>
  <script src="https://cdn.shopify.com/shopifycloud/shopify/assets/checkout-7748abbaf56f29669ab12079092ee11ac0a125f70e648c4effa7e345a9d23aab.js" crossorigin="anonymous"></script>
...
<body>
  <header class="banner" data-header role="banner">
    <div class="wrap">
      <span class="logo__text heading-1">Thanh toán - CPStore</span>
    </div>
  </header>

  <!-- cái này chỉ là header của mobi -->
          ...
          <dl class="order-summary-toggle__total-recap total-recap"
            ...
            <dd>
              <span class="order-summary__emphasis total-recap__final-price skeleton-while-loading"
                data-checkout-payment-due-target="3300">$33.00</span>
            </dd>
          </dl>
    </button>
  </aside>
    ...
    <div class="wrap">
      <div class="main">
        <header class="main__header" role="banner">
          <span class="logo__text heading-1">Thanh toán</span>
        </header>

        <main class="main__content" role="main">
          <div class="step" data-step="contact_information" data-last-step="false">
            <form data-customer-information-form="true" data-email-or-phone="true" class="edit_checkout"
                  ...
                  <div class="section__header">
                    <div class="layout-flex layout-flex--tight-vertical layout-flex--loose-horizontal layout-flex--wrap">
                      <h2 class="section__title layout-flex__item layout-flex__item--stretch"
                        ...
                        Thông tin</h2>
                      <p class="layout-flex__item">Đã có tài khoản?
                        <a href="{{route('login')}}">Đăng nhập</a></p>
                    </div>
                  </div>
                  <div class="section__content">
                    <div class="fieldset">
                      <div data-email-or-phone-input-wrapper="true"
                        data-shopify-pay-email-flow="false" class="field field--email_or_phone">
                        <label class="field__label" for="checkout_email_or_phone">
                          Email hoặc số điện thoại</label>
                        <div class="field__input-wrapper">
                          <input value="" placeholder="Email hoặc số điện thoại"
                            autocapitalize="off" spellcheck="false"
                            data-email-or-phone-input="true" data-phone-flag-input="true"
                            data-phone-flag-input-default-country="Vietnam"
                            data-autofocus="true" data-backup="email_or_phone"
                            data-address-type="shipping"
                            data-most-popular-countries="[&quot;India&quot;,&quot;Vietnam&quot;,&quot;United States&quot;,&quot;Hungary&quot;]"
                            data-phone-flag-label="Mã Quốc gia/Khu vực"
                            aria-describedby="checkout-context-step-one"
                            aria-required="true" class="field__input" size="30" type="email"
                            name="checkout[email_or_phone]" id="checkout_email_or_phone">
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="address-fields" data-address-fields>
                        <div class="field--half field field--optional"
                          ...
                          <label class="field__label"
                            for="checkout_shipping_address_first_name">Họ (không bắt buộc)</label>
                          <div class="field__input-wrapper">
                            <input placeholder="Họ (không bắt buộc)"
                        ...
                        <div class="field--half field field--required"
                          ...
                          <label class="field__label"
                            for="checkout_shipping_address_last_name">Tên</label>
                          <div class="field__input-wrapper">
                        ...
                        <div data-address-field="address1"
                          ...
                          <label class="field__label"
                            for="checkout_shipping_address_address1">Địa chỉ</label>
                          <div class="field__input-wrapper">
                            <input placeholder="Địa chỉ"
                              autocomplete="shipping address-line1" autocorrect="off"
                              data-backup="address1" class="field__input"
                              aria-required="true" size="30" type="text"
                        ...
                        <div data-address-field="address2"
                          ...
                          <label class="field__label"
                            for="checkout_shipping_address_address2">Căn hộ, phòng,..</label>
                          <div class="field__input-wrapper">
                            <input placeholder="Căn hộ, phòng,.."
                              autocomplete="shipping address-line2" autocorrect="off"
                              data-backup="address2" class="field__input" size="30"
                              type="text" name="checkout[shipping_address][address2]"
                        ...
                        <div data-address-field="city" data-autocomplete-field-container="true"
                          class="field field--required">
                          <label class="field__label"
                            for="checkout_shipping_address_city">Thành phố</label>
                          <div class="field__input-wrapper">
                            <input placeholder="Thành phố" autocomplete="shipping address-level2"
                        ...
                        <div class="field--third field field--required"
                          ...
                          data-autocomplete-field-container="true">
                          <label class="field__label"
                            for="checkout_shipping_address_country">Quốc gia/Khu vực</label>
                          <div class="field__input-wrapper field__input-wrapper--select">
                            <select size="1" autocomplete="shipping country"
                              ...
                              <option data-code="VN" value="Vietnam" selected>Vietnam</option>
                        ...
                        <div class="field--third field field--required"
                          ...
                          data-autocomplete-field-container="true">
                          <label class="field__label"
                            for="checkout_shipping_address_province">Khu vực</label>
                          <div class="field__input-wrapper field__input-wrapper--select">
                            <input placeholder="Khu vực"
                              autocomplete="shipping address-level1" autocorrect="off"
                              data-backup="province" class="field__input"
                        ...
                        <div class="field--third field field--required" data-address-field="zip"
                          data-autocomplete-field-container="true">
                          <label class="field__label"
                            for="checkout_shipping_address_zip">Mã bưu điện</label>
                          <div class="field__input-wrapper">
                            <input placeholder="Mã bưu điện"
                              autocomplete="shipping postal-code" autocorrect="off"
                              data-backup="zip" class="field__input field__input--zip"
                              aria-required="true" size="30" type="text"
              ...
              <div class="step__footer" data-step-footer>
                ...
                <a class="step__footer__previous-link" href="#"><svg
                  ...
                  </svg><span class="step__footer__previous-link-content">Tiếp tục mua sắm</span></a>
              </div>
              
              <div class="notice notice--warning default-background">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 22"
                  class="icon-svg icon-svg--size-32 notice__icon">
                ...
                <div class="notice__content">
                  <p class="notice__text">Hiện tại tiện ích thanh toán bằng thẻ tín dụng chưa phát triển
Mọi giao dịch đều dựa trên hình thức truyền thống
Mong quý khách thông cảm !</p>
                </div>
              </div>
                ...
                <div class="order-summary__section__content">
                  <table class="product-table">
                    ...
                    <tbody data-order-summary-section="line-items">
                      <tr class="product" data-product-id="5576601272477"
                        data-variant-id="35979387043997" data-product-type=""
                        data-customer-ready-visible>
                        <td class="product__image">
                          <div class="product-thumbnail ">
                            <div class="product-thumbnail__wrapper">
                              <img alt="Black In Faux JX Suede"
                                class="product-thumbnail__image"
                                src="https://cdn.shopify.com/s/files/1/0437/1913/1293/products/org_0000s_0017s_0000_1_small.jpg?v=1599129436">
                            </div>
                        ...
                        <th class="product__description" scope="row">
                          <span
                            class="product__description__name order-summary__emphasis">Black
                            In Faux JX Suede</span>
                          <span
                        ...
                        <td class="product__price">
                          <span
                            class="order-summary__emphasis skeleton-while-loading">$30.00</span>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <table class="total-line-table">
                  ...
                  <tbody class="total-line-table__tbody">
                    <tr class="total-line total-line--subtotal">
                      ...
                      <td class="total-line__price">
                        <span class="order-summary__emphasis skeleton-while-loading"
                          data-checkout-subtotal-price-target="3000">
                          $30.00
                        </span>
                      </td>
                    </tr>
                    ...
                    <tr class="total-line total-line--taxes " data-checkout-taxes>
                      ...
                      <td class="total-line__price">
                        <span class="order-summary__emphasis skeleton-while-loading"
                          data-checkout-total-taxes-target="300">$3.00</span>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr class="total-line">
                      ...
                      <td class="total-line__price payment-due" data-presentment-currency="USD">
                        ...
                        <span class="payment-due__price skeleton-while-loading--lg"
                          data-checkout-payment-due-target="3300">
                          $33.00
                        </span>
                      </td>
                    </tr>

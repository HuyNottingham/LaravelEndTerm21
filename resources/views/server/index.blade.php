          ...
          <div class="quick_activity_wrap">
            <div class="single_quick_activity d-flex">
              ...
              <div class="count_content">
                <h3><span class="blue_color">520</span> </h3>
                <p>Doctors</p>
              </div>
            </div>
            <div class="single_quick_activity d-flex">
              ...
              <div class="count_content">
                <h3><span class="red_color">6969</span> </h3>
                <p>Nurses</p>
              </div>
            </div>
            <div class="single_quick_activity d-flex">
              ...
              <div class="count_content">
                <h3><span class="yellow_color">7510</span> </h3>
                <p>Patients</p>
              </div>
            </div>
            <div class="single_quick_activity d-flex">
              ...
              <div class="count_content">
                <h3><span class="green_color">2110</span> </h3>
                <p>Pharmacusts</p>
              </div>
            </div>
          </div>
        ...
        <tbody>
            ...
            <th scope="row">
              <div class="patient_thumb d-flex align-items-center">
                <div class="student_list_img mr_20">
                  <img src="{{asset('img')}}/patient/pataint.png" alt="" srcset="">
                </div>
                <p>Jhon Kural</p>
              </div>
            </th>
          ...
          <tr>
            <th scope="row">
              <div class="patient_thumb d-flex align-items-center">
                <div class="student_list_img mr_20">
                  <img src="{{asset('img')}}/patient/2.png" alt="" srcset="">
                </div>
                <p>Jhon Kural</p>
              </div>
            </th>
          ...
          <tr>
            <th scope="row">
              <div class="patient_thumb d-flex align-items-center">
                <div class="student_list_img mr_20">
                  <img src="{{asset('img')}}/patient/3.png" alt="" srcset="">
                </div>
                <p>Jhon Kural</p>
              </div>
            </th>
          ...
          <tr>
            <th scope="row">
              <div class="patient_thumb d-flex align-items-center">
                <div class="student_list_img mr_20">
                  <img src="{{asset('img')}}/patient/4.png" alt="" srcset="">
                </div>
                <p>Jhon Kural</p>
              </div>
            </th>
          ...
          <tr>
            <th scope="row">
              <div class="patient_thumb d-flex align-items-center">
                <div class="student_list_img mr_20">
                  <img src="{{asset('img')}}/patient/5.png" alt="" srcset="">
                </div>
                <p>Jhon Kural</p>
              </div>
            </th>
          ...
          <tr>
            <th scope="row">
              <div class="patient_thumb d-flex align-items-center">
                <div class="student_list_img mr_20">
                  <img src="{{asset('img')}}/patient/6.png" alt="" srcset="">
                </div>
                <p>Jhon Kural</p>
              </div>
            </th>
